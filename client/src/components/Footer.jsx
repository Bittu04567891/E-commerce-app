    ...
    <Container>
      ...
      <Center>
        ...
        <List>
          ...
          <ListItem>
            {" "}
            <Link to="/products/kids">Kids Wear</Link>
          </ListItem>
          <ListItem>
            {" "}
          ...
          <ListItem>
            {" "}
            <Link to="/products/purse">Purses</Link>
          </ListItem>
          <ListItem>
            {" "}
            <Link to="/products/saree">Sarees</Link>
          </ListItem>
          <ListItem>
            {" "}
      ...
      <Right>
        ...
        <ContactItem>
          <MailOutline style={{ marginRight: "10px" }} /> prismcart@nitjsr.ac.in
        </ContactItem>
