...
const Footer = () => {
  return (
    <Container>
     ...
     <Right>
      <Title>Contact</Title>
      <ContactItem><LocationOn/>Hostel K,NIT Jamshedpur</ContactItem>
      <ContactItem><LocalPhone/> +91 7755937498</ContactItem>
      <ContactItem><MailOutline/> prismcart@nitjsr.ac.in</ContactItem>
